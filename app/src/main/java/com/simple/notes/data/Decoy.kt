...
/**
 * Наполнение чужого блокнота. Набор заметок выбирается из списка один раз —
 * при создании блокнота — и дальше хранится на диске, поэтому содержимое
 * больше не меняется. Пустой экран после ввода пароля выглядел бы
 * подозрительно, поэтому его не бывает.
 */
object Decoy {
