...
enum class MarkerType(
    ...
    CITY_FERRY("Переправа", MarkerGroup.CITY_SERVICE, Glyph.SHIP, 0.85f, MarkerScope.CITY),
    ...
    CITY_DUEL_GROUND("Место поединков", MarkerGroup.CITY_SPECIAL, Glyph.SWORD, 0.95f, MarkerScope.CITY),
