  ...
  const submit = async () => {
    ...
    try {
      if (mode === 'signin') {
        ...
        Alert.alert(
          'Аккаунт создан',
          'Если пришло письмо с подтверждением — нажмите ссылку в нём. Откроется пустая ' +
            'страница, так и должно быть: аккаунт уже подтверждён. Возвращайтесь сюда и входите.',
        );
      }
    } catch (e: any) {
